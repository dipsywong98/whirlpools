...
use anchor_spl::{associated_token::Create, token::{self, Mint, Token, TokenAccount, Transfer}};
...
pub fn mint_position_token_with_metadata_and_remove_authority<'info>(
    ...
    invoke_signed(
        &CreateMetadataAccountV3 {
            ...
            mint_authority: metadata_mint_auth_account.key(),
            payer: funder.key(),
            update_authority: (metadata_update_auth.key(), false),
            system_program: system_program.key(),
            rent: None,
        }.instruction(CreateMetadataAccountV3InstructionArgs { data: 
            DataV2 {
...
pub fn mint_position_bundle_token_with_metadata_and_remove_authority<'info>(
    ...
    invoke_signed(
        &CreateMetadataAccountV3 {
            metadata: position_bundle_metadata.key(),
            mint: position_bundle_mint.key(),
            mint_authority: position_bundle.key(),
            payer: funder.key(),
            update_authority: (metadata_update_auth.key(), false),
            system_program: system_program.key(),
            rent: None,
